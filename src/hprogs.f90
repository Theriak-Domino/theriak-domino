!hprogs.f90  Version: 29.11.2022-dev
! -----------------------------------------------------------------------
...
!-----
!******************************
      SUBROUTINE PUSTU(I001,CH)
      IMPLICIT NONE
      CHARACTER*(*) CH
      INTEGER(4) I001,II,I
      CALL LABLA(CH,II)
      IF (II.EQ.0) II=1
      WRITE (UNIT=I001,FMT='(130A1)') ('-',I=1,II)
      WRITE (UNIT=I001,FMT='(A)') CH(1:II)
      WRITE (UNIT=I001,FMT='(130A1)') ('-',I=1,II)
      RETURN
      END
