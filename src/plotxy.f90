!plotxy.f90  Version: 29.11.2022-dev
! -----------------------------------------------------------------------
...
!      LOGICAL(4) VERGL
      ...
      CHARACTER(80) INFILE
      INTEGER(4) I,I001,I002,I1,I2,IU,LARG,IFNR
      INTEGER(4) j, ierr
!*****
!-----
      LARG=0
...
!       no idea why its not working anymore
      NROW=0
      DO I=1,MAXIROW
       READ (dbs,FMT='(A)',END=888) SYSIN
       READ (SYSIN,*,END=887) (TABELLE(I,I1),I1=1,NCOL)
  887 CONTINUE
       NROW=I
      END DO
  888 CONTINUE
...
!-----
      ...
      IF (I002.EQ.0) I002=1
      CH002=' Enter Y-axis: [ "?" | CR | number(s) ] <'// & 
      CHIN(3)(1:I002)//'>?'
!-----
      WRITE (UNIT=scr,FMT='('' '')')
      CALL PUST (6,CH002)
